...
Encoder.prototype._transform = function (buf, encoding, fn) {
  ...
  if (this._headerWritten) {
    ...
    this._writeHeader(null, process);
  }
...
Encoder.prototype._writeHeader = function (unused, fn) {
  debug('_writeHeader()');
...
Encoder.prototype._blockout = function (unused, fn) {
  debug('_blockout');
  var vd = this.vd;
  var vb = this.vb;
  var self = this;
  binding.vorbis_analysis_blockout(vd, vb, function (rtn) {
    ...
    if (1 === rtn) {
      ...
      self._flushpacket(null, afterFlush);
    } else if (0 === rtn) {
      // need more PCM data...
      fn();
    } else {
...
Encoder.prototype._flushpacket = function (unused, fn) {
  debug('_flushpacket()');
  var self = this;
...
Encoder.prototype._flush = function (unused, fn) {
  debug('_onflush()');
